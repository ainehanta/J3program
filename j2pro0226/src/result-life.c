...
void NavigateToLifeResult(tikka_status* tikka)
{
	...
	bg = SDL_LoadBMP("./res/result-life/result-life-bg.bmp");
	button_next = SDL_LoadBMP("./res/result-life/result-life-button-next.bmp");
	button_next_pressed = SDL_LoadBMP("./res/result-life/result-life-button-pressed.bmp");
